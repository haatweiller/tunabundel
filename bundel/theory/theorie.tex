...
\multicolumn{2}{c}{dynamisch} & \multicolumn{2}{c}{andalusische cadans}\\
\multicolumn{2}{p{9em}@{}}{/\dashfill\textbackslash} & \multicolumn{2}{p{9em}@{}}{/\dashfill\textbackslash}\\
E & Am & G \hspace{1em} F & E\\
I & iv & III \hspace{0.7em} II & I
\end{tabular}

\begin{tabular}{*{4}{|p{2em}}|}
\multicolumn{4}{c}{statisch}\\
E & & F & E \\
I & & II & I
\end{tabular}

Naar \chord*{A}-majeur (\chord*{E} is ``toevallig'' dominant van \chord*{A}, overgang klinkt dus natuurlijk, gebeurt ook in Julio bij het refrein)

Substitutie van \chord*{Bm} voor \chord*{D} (IV). Bm is de relatieve mineur tegenhanger van \chord*{D}.

einde op vrolijke noot \chord*{F} \chord*{E} (kort uitstapje naar frygisch) \chord*{A} (happy end) in plaats van in frygisch te blijven: \chord*{G} \chord*{F} \chord*{E} (duister einde)
