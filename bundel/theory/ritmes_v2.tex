...
%$\Downarrow$\hspace{2em}\hphantom{$\uparrow$}\hspace{2.1em}$\downarrow$\hspace{2em}$\uparrow$\hspace{2.1em}$\downarrow$\hspace{2em}$\uparrow$\\
...
\subsubsection*{Cubaanse Bolero (2/4) en Bossa Nova(4/4)}
